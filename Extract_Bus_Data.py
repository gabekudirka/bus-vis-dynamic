...
# %%
with open('./Original_Data/2. Deployment Plans/1. Solutions/p20.txt') as p20, open('./Original_Data/2. Deployment Plans/1. Solutions/p60.txt') as p60, open('./Original_Data/2. Deployment Plans/1. Solutions/p180.txt') as p180:
    p20_data = p20.readlines()
    p60_data = p60.readlines()
    p180_data = p180.readlines()

#%%
UTA_runcut_df = pd.read_csv('./Original_Data/1. Network Data/3. UTA Runcut File  Aug2016.csv', header=0)
UTA_stops_df = pd.read_csv('./Original_Data/2. Deployment Plans/2. UTA_Runcut_Potential_Stop.csv', header=0)
bus_env_impact_df = pd.read_csv('./Original_Data/3. Supplementary Data/8. Ei_for_bus.csv', header=0)
