...
# %%
f = open('./taz_data/TAZ.json', 'r')
base_taz_regions = json.load(f)
f.close()

# %%
income_df = pd.read_csv('./taz_data/Marginal_Income.csv')
household_df = pd.read_csv('./taz_data/SE_File_v83_SE19_Net19.csv')
...
with open('TAZ_with_data2.json', 'w') as f:
    json.dump(base_taz_regions, f)